...
const HollowedBox = (props: any) => (
  <Svg
    ...
    {...props}
  >
    <Rect fill="#487346" width={200} height={200} />
    <G fillOpacity={1}>
      <Polygon fill="#4c8e43" points="100 57.1 64 93.1 71.5 100.6 100 72.1" />
      <Polygon
        fill="#6aac5f"
      ...
      />
      <Polygon fill="#768c3a" points="0 157.1 0 172.1 28.6 200.6 36.1 193.1" />
      <Polygon fill="#96ac58" points="70.7 200 70.8 192.4 63.2 200" />
      <Polygon
        fill="#B6CC76"
      ...
      />
      <Polygon fill="#768c3a" points="136.7 200 129.2 192.5 129.2 200" />
      <Polygon
        fill="#B6CC76"
      ...
      />
      <Polygon fill="#96ac58" points="63.2 0 0 63.2 0 78.2 70.7 7.5 70.7 0" />
      <Polygon fill="#B6CC76" points="0 63.2 63.2 0 27.8 0 0 27.8" />
    </G>
  </Svg>
);
export default HollowedBox;
